                ...
                t.exports = function () {
                    ...
                    const i = {}
                        ...
                        , Z = (t, e) => {
                            ...
                            for (let t = 0; t < n.length; t++) {
                                const o = n[t];
                                if (o instanceof HTMLElement && F(o, e))
                                    return o
                            }
                        }
                        , $ = (t, e, n) => {
                            ...
                            n && o && (e.showConfirmButton || e.showDenyButton || e.showCancelButton ? J(n) : X(n),
                                ...
                                function (t, e, n) {
                                    const o = L()
                                        , i = O()
                                        , s = S();
                                    o && i && s && (mt(o, "confirm", n),
                                        mt(i, "deny", n),
                                        mt(s, "cancel", n),
                                        function (t, e, n, o) {
                                            o.buttonsStyling ? (K([t, e, n], a.styled),
                                                ...
                                                o.cancelButtonColor && (n.style.backgroundColor = o.cancelButtonColor,
                                                    K(n, a["default-outline"]))) : Y([t, e, n], a.styled)
                                        }(o, i, s, n),
                    ...
                    const gt = (t, e) => {
                        ...
                        n && (function (t, e) {
                            ...
                            function (t, e) {
                                e && (e in a ? K(t, a[e]) : (d('The "position" parameter is not valid, defaulting to "center"'),
                                    K(t, a.center)))
                            }(n, e.position),
                            function (t, e) {
                    ...
                    const ht = ["input", "file", "range", "select", "radio", "checkbox", "textarea"]
                        , bt = t => {
                            if (!t.input)
                                return;
                            if (!Bt[t.input])
                    ...
                    const xt = (t, e) => {
                        ...
                        , Ft = (t, e, n) => {
                            t && (e.isComposing || 229 === e.keyCode || (t.stopKeydownPropagation && e.stopPropagation(),
                                "Enter" === e.key ? Rt(e, t) : "Tab" === e.key ? Ut(e) : [..._t, ...Nt].includes(e.key) ? zt(e.key) : "Escape" === e.key && Wt(e, t, n)))
                        }
                        , Rt = (t, e) => {
                            if (!f(e.allowEnterKey))
                                return;
                            const n = U(A(), e.input);
                    ...
                    const se = t => {
                        ...
                        , fe = (t, e) => {
                            ...
                            const o = t => {
                                ...
                                ;
                            h(e.inputOptions) || y(e.inputOptions) ? (ue(L()),
                    ...
                    const gn = ["swal-title", "swal-html", "swal-footer"]
                        ...
                        , Bn = t => {
                            ...
                            Tn(e, n, t),
                                ...
                                _() || i.previousActiveElement || (i.previousActiveElement = document.activeElement),
                        ...
                        , xn = t => {
                            ...
                            if (t.target !== e || !dt)
                                return;
                            const n = w();
                            e.removeEventListener(dt, xn),
                                n.style.overflowY = "auto"
                        }
                        , En = (t, e) => {
                            dt && nt(e) ? (t.style.overflowY = "hidden",
                                e.addEventListener(dt, xn)) : t.style.overflowY = "auto"
                        }
                        , Pn = (t, e, n) => {
                            (() => {
                    ...
                    const Hn = (t, e, n) => new Promise(((o, s) => {
                        ...
                        Kt.swalPromiseResolve.set(t, o),
                            ...
                            ((t, e, n) => {
                                qt(t),
                                    e.toast || (t.keydownHandler = t => Ft(e, t, n),
                            ...
                            ((t, e) => {
                                "select" === e.input || "radio" === e.input ? fe(t, e) : ["text", "email", "number", "tel", "textarea"].some((t => t === e.input)) && (h(e.inputValue) || y(e.inputValue)) && (ue(L()),
                                    he(t, e))
                            }
                            )(t, n),
                            Bn(n),
                        ...
                        , _n = (t, e) => e.focusDeny && tt(t.denyButton) ? (t.denyButton.focus(),

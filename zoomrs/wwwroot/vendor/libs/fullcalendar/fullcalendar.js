    ...
    return function() {
        ...
        function T(e, t, n, r, i, s, o, a, l, c) {
            ...
            for (n.__k = [], d = 0; d < t.length; d++)
                if (null != (p = n.__k[d] = null == (p = t[d]) || "boolean" == typeof p ? null : "string" == typeof p || "number" == typeof p || "bigint" == typeof p ? v(null, p, null, null, p) : Array.isArray(p) ? v(y, {
                    ...
                    N(e, p, g = g || u, i, s, o, a, l, c), m = p.__e, (f = p.ref) && g.ref != f && (E || (E = []), g.ref && E.push(g.ref, null, p), E.push(f, p.__c || m, p)), null != m ? (null == b && (b = m), "function" == typeof p.type && p.__k === g.__k ? p.__d = l = k(p, l, e) : l = O(e, p, g, A, m, l), "function" == typeof n.type && (n.__d = l)) : l && g.__e == l && l.parentNode != e && (l = w(g))
                }
        ...
        class Ti {
            ...
            insertEntryAt(e, t) {
                let {
                    entriesByLevel: n,
                    levelCoords: r
                } = this; - 1 === t.lateral ? (Ii(r, t.level, t.levelCoord), Ii(n, t.level, [e])) : Ii(n[t.level], t.lateral, e), this.stackCnts[Mi(e)] = t.stackCnt
            }
            findInsertion(e) {
                let {
                    levelCoords: t,
            ...
            render() {
                ...
                return m(wn.Consumer, null, (n => {
                    let {
                        ...
                        moreCnt: a
                    } = e, l = Os(e), c = "function" == typeof o ? o.call(s, a) : `+${a} ${o}`, d = Ke(i.moreLinkHint, [a], c), u = {
                        num: a,
                        shortText: `+${a}`,
                        text: c,
                        view: r
        ...
        class mo {
            constructor(e) {
                ...
                }(), this.buildDateEnv = Mt(vo), this.buildTheme = Mt(yo), this.parseToolbars = Mt(ao), this.buildViewSpecs = Mt(qs), this.buildDateProfileGenerator = Ot(bo), this.buildViewApi = Mt(Eo), this.buildViewUiProps = Ot(Do), this.buildEventUiBySource = Mt(Ao, un), this.buildEventUiBases = Mt(So), this.parseContextBusinessHours = Ot(Co), this.buildTitle = Mt(po), this.emitter = new Dr, this.actionRunner = new go(this._handleAction.bind(this), this.updateData.bind(this)), this.currentCalendarOptionsInput = {}, this.currentCalendarOptionsRefined = {}, this.currentViewOptionsInput = {}, this.currentViewOptionsRefined = {}, this.currentCalendarOptionsRefiners = {}, this.optionsForRefining = [], this.optionsForHandling = [], this.getCurrentData = () => this.data, this.dispatch = e => {
        ...
        class Oo extends Rn {
            constructor() {
                super(...arguments), this.buildViewContext = Mt(Cn), this.buildViewPropTransformers = Mt(No), this.buildToolbarProps = Mt(Io), this.headerRef = {
                    current: null
                }, this.footerRef = {
                    current: null
        ...
        class Po extends oi {
            constructor(e, t = {}) {
                super(), this.isRendering = !1, this.isRendered = !1, this.currentClassNames = [], this.customContentRenderId = 0, this.handleAction = e => {
                    ...
                    }(e), this.el = e, this.renderRunner = new Oe(this.handleRenderRequest), new mo({
                        optionOverrides: t,
                        calendarApi: this,
        ...
        class Wo extends _n {
            render() {
                let {
                    ...
                    seg: r
                } = e, i = Gr(r, n.eventTimeFormat || zo, t, !0, e.defaultDisplayEventEnd);
                return m(ps, Object.assign({}, e, {
                    elTag: "a",
        ...
        class Ko extends xi {
            ...
            render() {
                let {
                    ...
                    options: r
                } = n, i = e.cells.length, s = Bo(e.businessHourSegs, i), o = Bo(e.bgEventSegs, i), a = Bo(this.getHighlightSegs(), i), l = Bo(this.getMirrorSegs(), i), {
        ...
        class ea extends xi {
            constructor() {
                super(...arguments), this.splitBusinessHourSegs = Mt(Ho), this.splitBgEventSegs = Mt(Ho), this.splitFgEventSegs = Mt(Ho), this.splitDateSelectionSegs = Mt(Ho), this.splitEventDrag = Mt(jo), this.splitEventResize = Mt(jo), this.rowRefs = new ss
            }
            render() {
                let {
                    props: e,
            ...
            views: {
                dayGrid: {
                    component: class extends sa {
                        constructor() {
                            super(...arguments), this.buildDayTableModel = Mt(oa), this.headerRef = {
                                current: null
                            }, this.tableRef = {
                                current: null
                            }
        ...
        class Ea {
            ...
            isWithinClipping(e, t) {
                ...
                for (let e of this.scrollCaches)
                    if (!Aa(e.getEventTarget()) && !ai(n, e.clientRect)) return !1;
                return !0
            }
        }
        ...
        class Ca extends ri {
            constructor(e) {
                super(e), this.subjectEl = null, this.subjectSeg = null, this.isDragging = !1, this.eventRange = null, this.relevantEvents = null, this.receivingContext = null, this.validMutation = null, this.mutatedRelevantEvents = null, this.handlePointerDown = e => {
                    ...
                    this.displayDrag(s, c), l ? Ze() : Xe(), t || (i === s && Da(r, e) && (o = null), this.dragging.setMirrorNeedsRevert(!o), this.dragging.setMirrorIsVisible(!e || !this.subjectEl.getRootNode().querySelector(".fc-event-mirror")), this.receivingContext = s, this.validMutation = o, this.mutatedRelevantEvents = a)
                ...
                let {
                    ...
                    options: n
                } = t.context, r = this.dragging = new ba(e.el);
        ...
        var xa = Ws({
            ...
            componentInteractions: [class extends ri {
                constructor(e) {
                    ...
                    }, this.dragging = new ba(e.el), this.dragging.autoScroller.isEnabled = !1;
                ...
                constructor(e) {
                    super(e), this.draggingSegEl = null, this.draggingSeg = null, this.eventRange = null, this.relevantEvents = null, this.validMutation = null, this.mutatedRelevantEvents = null, this.handlePointerDown = e => {
                        ...
                        }), c ? Ze() : Xe(), t || (a && Da(s, e) && (a = null), this.validMutation = a, this.mutatedRelevantEvents = l)
                    }, this.handleDragEnd = e => {
                        let {
                            context: t
                        } = this.component, n = this.eventRange.def, r = this.eventRange.instance, i = new Or(t, n, r), s = this.relevantEvents, o = this.mutatedRelevantEvents;
            ...
            views: {
                list: {
                    component: class extends xi {
                        constructor() {
                            super(...arguments), this.computeDateVars = Mt(Pa), this.eventStoreToSegs = Mt(this._eventStoreToSegs), this.state = {
                                timeHeaderId: Le(),
                                eventHeaderId: Le(),
                                dateHeaderIdRoot: Le()
                            }, this.setRootEl = e => {
        ...
        function Ua(e) {
            ...
            return m(wn.Consumer, null, (n => {
                ...
                let {
                    ...
                    options: i,
                    viewApi: s
                } = n, o = null == i.slotLabelFormat ? za : Array.isArray(i.slotLabelFormat) ? Qt(i.slotLabelFormat[0]) : Qt(i.slotLabelFormat), a = {
                    level: 0,
                    time: e.time,
        ...
        class ol extends _n {
            ...
            renderPositionedFgSegs(e, t, n, r, i, s) {
                let {
                    ...
                    todayRange: f,
                    nowDate: g
                } = this.props, p = n || r || i, v = rl(e, d, u, c), {
                    segPlacements: b,
                    hiddenGroups: E
                } = function(e, t, n, r) {
                    let i = [],
                    ...
                    let {
                        ...
                        let i = function(e) {
                                ...
                                for (let i of e) {
                                    ...
                                    for (let i of t) Oi(i.span, s.span) ? s = {
                ...
                return m(y, null, this.renderHiddenGroups(E, e), b.map((e => {
                    let {
                        seg: o,
                        rect: l
                    } = e, c = o.eventRange.instance.instanceId, d = p || Boolean(!t[c] && l), u = ll(l && l.span), v = !p && l ? this.computeSegHStyle(l) : {
                        left: 0,
                        right: 0
            ...
            renderFillSegs(e, t) {
                let {
                    props: n,
                    context: r
                } = this, i = rl(e, n.date, n.slatCoords, r.options.eventMinHeight).map(((r, i) => {
                    let s = e[i];
                    return m("div", {
                        key: qr(s.eventRange),
        ...
        class cl extends _n {
            constructor() {
                super(...arguments), this.splitFgEventSegs = Mt(Za), this.splitBgEventSegs = Mt(Za), this.splitBusinessHourSegs = Mt(Za), this.splitNowIndicatorSegs = Mt(Za), this.splitDateSelectionSegs = Mt(Za), this.splitEventDrag = Mt(Xa), this.splitEventResize = Mt(Xa), this.rootElRef = {
                    current: null
        ...
        class dl extends xi {
            constructor() {
                super(...arguments), this.processSlotOptions = Mt(ul), this.state = {
                    slatCoords: null
                }, this.handleRootEl = e => {
                    e ? this.context.registerInteractiveComponent(this, {
                        el: e,
        ...
        class fl extends xi {
            constructor() {
                super(...arguments), this.buildDayRanges = Mt(gl), this.slicer = new hl, this.timeColsRef = {
                    current: null
                }
            }
            render() {
            ...
            let s = new Date(0),
                ...
                l = n || function(e) {
                    ...
                    for (t = pl.length - 1; t >= 0; t -= 1)
                        if (n = st(pl[t]), r = dt(n, e), null !== r && r > 1) return n;
                    return e
                }(r),
                c = [];
            for (; ct(o) < ct(t);) {
                    ...
                    component: class extends Va {
                        ...
                        render() {
                            let {
                                ...
                                clientHeight: t.clientHeight,
                                forPrint: r.forPrint
                            }, this.getAllDayMaxEventProps()))), f = t => m(fl, Object.assign({}, o.timed, {
                                dayTableModel: s,
                                dateProfile: i,
                                axis: c,
                                slotDuration: e.slotDuration,
